...
class ActivityMonthlyDetailedSales : ActivityBase() {

    //viewBinding
    private lateinit var binding: ActivityMonthlyDetailedSalesBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMonthlyDetailedSalesBinding.inflate(layoutInflater)
    ...
    private fun setLayout() {
        ...
        binding.actDetailedPerformMonthTv.setOnClickListener {
            val dialog = AlertDialog.Builder(this@ActivityMonthlyDetailedSales).create()
            val edialog: LayoutInflater = LayoutInflater.from(this@ActivityMonthlyDetailedSales)
...
//            hour.displayedValues = arrayOf("06시")
            ...
            ok.setOnClickListener {
                ...
                Toast.makeText(this@ActivityMonthlyDetailedSales,
...
//                }
        ...
        binding.cashCardview.setOnClickListener {
            val intent = Intent(this, ActivitySalesAnalysis::class.java)
            intent.putExtra("cardcash", "현금")
