...
import com.example.today_seyebrowktver.ui.ActivityEditCustomer
import com.example.today_seyebrowktver.ui.ActivityUpdateMessage
import com.google.android.material.bottomsheet.BottomSheetDialogFragment


class BottomSheetFragmentMessageUpdateCheck : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        saveTv.setOnClickListener {
            dismiss()
            (activity as ActivityUpdateMessage).mSaveUpdatedMessageData()
        }
    }
